...
def connect():
    conn = psycopg2.connect(database="steps", user="postgres", password="222", host="localhost", port="5432")
    cur = conn.cursor()
...
if __name__ == '__main__':
    ...
    prediction = predict(current_duration, feedback)
